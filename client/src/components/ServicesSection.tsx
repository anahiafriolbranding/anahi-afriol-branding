...
/*
 * Services Section - Zona caliente #2
 * SEO: H2 con keywords de servicios principales
 * Layout: Cards asimétricas con iconos y descripciones
 * Copy: Más directo, voz de estratega
 */
  ...
  return (
    <section id="servicios" className="py-24 bg-background" aria-label="Servicios de branding verbal, visual y espacial para Pymes">
      <div className="container">
        ...
        {/* Process strip */}
        <div className="mt-20 bg-petrol rounded-2xl p-8 sm:p-12 relative overflow-hidden">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={item.step} className="relative">
                  <span className="text-coral font-bold text-4xl font-[family-name:var(--font-display)]">{item.step}</span>
